...
def request_discovery(device_info_static, device_info_dynamic) -> str:
...
def response_discovery(device_info_static, device_info_dynamic) -> str:
...
def update_peer_view(device_info_static, device_info_dynamic) -> str:
...
def process_message(device_info_static, device_info_dynamic, message) -> str:
...
def request_answerer(device_info_static, device_info_dynamic, message_specivication) -> str:
...
def response_extractor(message_specivication, message_payload) -> str:
    if message_specivication == ' peer discovery':
