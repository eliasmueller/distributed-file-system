...
def discoverPeers(device_info_static, device_info_dynamic, shared_queue):
    ...
    #update group view
    new_peer_view = interprete_discovery_answers(device_info_static, answers)
...
def interprete_discovery_answers(device_info_static, answers) -> []:
    ...
    for answer in answers:
        new_peer_view.append(formater.get_sender_ID(answer))
    ...
    if device_info_static.PEER_ID not in new_peer_view:
        ...
        new_peer_view.append(device_info_static.PEER_ID)
